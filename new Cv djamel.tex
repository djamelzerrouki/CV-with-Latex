...
\mobile{0669706401}                          % optional, remove/comment the line if not wanted
...
\email{djameljimmizerrouki@gmail.com}                               % optional, remove/comment the line if not wanted
\homepage{home page}                         % optional, remove/comment the line if not wanted
\extrainfo{additional information}                 % optional, remove/comment the line if not wanted
 \photo[64pt][0.4pt]{../djamel.jpg}                       % optional, uncomment the line if wanted; '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
...
\makecvtitle
\section{Education}
\cventry{2013--2014}{Baccalaureate in Experimental Sciences}{}{Algeria}{}{With a good mention}
\cventry{2016--2017}{licence in Mathematics and Computer Science}{University ibn khaldoun}{ Tiaret}{Grade}{Description}  % arguments 3 to 6 can be left empty

\cventry{2016--2017}{French language diploma}{University ibn khaldoun}{Tiaret}{A}{Formation de langage France d’une volume de 60 heures}  % arguments 3 to 6 can be left empty
\cventry{2017--2018}{CCNA Routing and Switching}{instptiaret}{Algeria}{CCNA 1}{introduction to Networks Cisco Netwerking
	Academy}  % arguments 3 to 6 can be left empty
